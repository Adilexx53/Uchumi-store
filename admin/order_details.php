...
// Get order items
$stmt = $conn->prepare("SELECT oi.*, p.name, p.image_url FROM order_items oi LEFT JOIN products p ON oi.product_id = p.id WHERE oi.order_id = ?");
$stmt->bind_param("i", $order_id);
$stmt->execute();
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="display: flex; align-items: center; gap: 10px;">
                            <img src="../<?php echo $item['image_url']; ?>" style="width: 40px; height: 40px; object-fit: cover; border-radius: 5px;">
                            <?php echo $item['name']; ?>
                        </td>
